...
public class HrController {
	...
	@Autowired
	public HrController(UserRepositoryImplementation implementation,JWTprovider jwTprovider,KagriPostServiceClass recipeServiceClass,userRepository userRepository,UserServiceClass userServiceClass) {
