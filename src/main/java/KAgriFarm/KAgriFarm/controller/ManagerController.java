...
public class ManagerController {
	...
	@Autowired
	public ManagerController(UserRepositoryImplementation implementation,JWTprovider jwTprovider,KagriPostServiceClass recipeServiceClass,userRepository userRepository,UserServiceClass userServiceClass) {
	...
	public UserModel UpdateManagerProfile(@RequestBody UserModel UpdateData, HttpServletRequest JwtToken)
			throws Exception {
		String token = (String) JwtToken.getAttribute("Authorization");
		String EmailId=jwTprovider.EmailId(token);
		UserModel user = implementation.findByEmail(EmailId);
